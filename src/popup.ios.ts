    ...
    public showPopup(source: any, view: any): Promise<boolean> {
        return new Promise((resolve, reject) => {
            ...
            if (view instanceof View) {
                ...
                switch (this._options.unit) {
                    case 'px':
                        ...
                        ios._layoutRootView(view, CGRectMake(0, isTablet ? 0 : ios.getStatusBarHeight(), layout.toDeviceIndependentPixels(width), layout.toDeviceIndependentPixels(height)));
                        break;
                    case '%':
                        if (this._options.height && !this._options.width) {
                        ...
                        ios._layoutRootView(view, CGRectMake(0, isTablet ? 0 : ios.getStatusBarHeight(), width, height));
                        break;
                    default:
                        if (this._options.height && !this._options.width) {
                            height = this._options.height;
            ...
            if (source instanceof View) {
                ...
                (<UINavigationController>topmost().ios.controller).presentModalViewControllerAnimated(this._popupController, true);
